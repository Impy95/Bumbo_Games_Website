...
<asp:Content ID="Content2" ContentPlaceHolderID="phrContent" runat="server">
    <div>
        <asp:Login ID="lgnUser" runat="server" BackColor="#F7F6F3" BorderColor="#E6E2D8" BorderPadding="4" BorderStyle="Solid" BorderWidth="8px" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#333333" OnAuthenticate="lgnUser_Authenticate"  >
